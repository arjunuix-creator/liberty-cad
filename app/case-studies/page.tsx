...
const testimonial: Testimonial = {
  quote:
    "Liberty CAD Inc has become an extension of our engineering team. Their understanding of fabrication constraints means we spend less time on revisions and more time building.",
