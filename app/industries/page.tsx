...
export const metadata: Metadata = {
  title: "Industries — Liberty CAD Inc",
  description:
    ...
    <>
      ...
      <main>
        <PageHero
          ...
          description="Liberty CAD Inc provides engineering consulting services across the industries that power our world. Our multidisciplinary expertise spans the unique requirements, codes, and challenges of each sector."
        />
