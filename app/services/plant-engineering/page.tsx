...
export const metadata: Metadata = {
  title: "Plant Engineering — Liberty CAD",
  description:
    ...
    <>
      ...
      <main>
            ...
            <AnimateOnScroll>
              <div className="max-w-[780px] mx-auto text-center mb-16">
                ...
                <p className="font-[family-name:var(--font-inter)] text-[16px] text-[#7a8694] leading-[1.8] mb-5">
                  Liberty CAD provides a full spectrum of engineering consulting services for Oil &amp; Gas,
        ...
        <CTASection
          ...
          description="Get in touch to discuss your project requirements and how Liberty CAD can support your goals."
