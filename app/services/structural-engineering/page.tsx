...
export const metadata: Metadata = {
  title: "Structural Engineering — Liberty CAD Inc",
  description:
    ...
    <>
      ...
      <main>
            ...
            <AnimateOnScroll>
              <div className="max-w-[780px] mx-auto text-center mb-16">
                ...
                <p className="font-[family-name:var(--font-inter)] text-[16px] text-[#7a8694] leading-[1.8] mb-5">
                  Liberty CAD Inc provides structural steel detailing services for all kinds of structures
        ...
        <CTASection
          ...
          description="Get in touch to discuss your structural steel requirements and how Liberty CAD Inc can deliver."
